      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-800 via-earth-800 to-spice-900 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative text-center px-12">
          ...
          <p className="font-body text-earth-300 text-lg leading-relaxed">
            Authentic Indian pickles made from age-old family recipes. No
            preservatives, no compromises.
          </p>
          <div className="mt-10 grid grid-cols-3 gap-4">
            {[
              { emoji: "🌶️", label: "28+ Varieties" },
              ...
              >
                ...
                <p className="font-body text-xs font-bold text-brand-200">
                  {label}
                </p>
              </div>
            ))}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="font-body text-sm font-bold text-earth-700">
                  Password
                </label>
                {mode === "login" && (
                  <Link
