      ...
      <div className="page-container">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <Link to="/products" className="inline-flex items-center gap-2 mt-5 font-body text-sm text-earth-500 hover:text-brand-700 transition-colors">
              ← Continue Shopping
            </Link>
          </div>
          ...
          <div className="lg:col-span-1">
            <div className="card p-6 sticky top-24">
              <h2 className="font-display font-bold text-earth-900 text-xl mb-6">Order Summary</h2>
              ...
              {cartTotal >= SHIPPING_THRESHOLD && (
                <div className="mb-5 p-3 bg-leaf-50 rounded-xl border border-leaf-100">
                  <p className="font-body text-xs text-leaf-700 font-bold">🎉 You qualify for free shipping!</p>
                </div>
              )}
              ...
              <div className="mt-4 flex items-center justify-center gap-4 text-earth-400">
                {['🔒 Secure', '📦 Packed well', '↩️ Easy returns'].map((t) => (
                  <span key={t} className="font-body text-xs">{t}</span>
                ))}
              </div>
            </div>
          </div>
