          ...
          <table className="w-full min-w-[700px]">
            <thead>
              <tr className="border-b border-earth-200 bg-earth-50">
                {['Product', 'Category', 'Variants / Price', 'Stock', 'Status', 'Actions'].map((h) => (
                  <th
                    key={h}
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-earth-100 flex-shrink-0
                        ...
                        <div className="min-w-0">
                          ...
                          {product.isFeatured && (
                            <span className="font-body text-xs text-brand-600 font-bold">⭐ Featured</span>
                          )}
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      <span className={`badge text-xs ${catInfo?.color || 'bg-earth-100 text-earth-700'}`}>
                    ...
                    {/* Stock */}
                    <td className="px-4 py-3 whitespace-nowrap">
                      <p className={`font-body text-sm font-bold ${isLowStock ? 'text-spice-600' : 'text-earth-900'}`}>
                        {totalStock} units
                      </p>
                      {isLowStock && (
                        <p className="font-body text-xs text-spice-500">⚠️ Low stock</p>
                      )}
                    </td>
