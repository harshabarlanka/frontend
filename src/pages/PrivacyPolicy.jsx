...
const PrivacyPolicy = () => {
  useSEO({
    title: "Privacy Policy — Naidu Gari Ruchulu",
    description:
      "Our privacy policy explains how we collect, use and protect your personal data when you shop at Naidu Gari Ruchulu.",
  ...
  return (
    <div className="page-container py-24 max-w-4xl">
      ...
      <p>
        ...
        <strong> Naidu Gari Ruchulu</strong>, we ensure that your personal
