...
const TESTIMONIALS = [
  { name: "Suresh K.", city: "Guntur", text: "The veg pickles are just like my Grandmother used to make. Absolutely authentic!", stars: 5 },
  { name: "Ramu C.", city: "Visakhapatnam", text: "Best non-veg pickle I've ever tasted. My wife ordered three packs already!", stars: 5 },
  { name: "Srinivas Rao.", city: "Hyderabad", text: "Fast delivery and perfectly sealed packs. The sweets and snacks are divine.", stars: 5 },
];

const TRUST_POINTS = [
  { title: "Homemade Recipes", text: "Traditional recipes made in small batches.", icon: FiHeart },
  { title: "Fresh Dispatch", text: "Prepared fresh and delivered safely to your home.", icon: FiTruck },
  { title: "Clean Ingredients", text: "No preservatives, no shortcuts — only quality ingredients.", icon: FiShield },
  { title: "Loved by Families", text: "Trusted by customers who keep coming back.", icon: FiStar },
];

const SkeletonCard = () => (
  <div className="overflow-hidden rounded-[24px] border border-white/70 bg-white p-4 shadow-[0_16px_45px_rgba(15,23,42,0.06)]" aria-hidden="true">
...
const HomePage = () => {
  useSEO({
    ...
    description: "Naidu Gari Ruchulu — Order authentic Andhra homemade Avakaya, Chicken Pickle, Gongura Pickle, Prawns Pickle, Sweets & Snacks online. No preservatives. Pan-India delivery.",
  ...
  return (
    <div className="relative overflow-hidden bg-white text-earth-900 animate-fade-in">
      ...
      <section className="relative w-full" aria-label="Hero banner">
        ...
        <div className="absolute inset-0 bg-black/30 sm:bg-black/40" aria-hidden="true" />
      </section>

      {/* Promo strip */}
      <section className="-mt-8 relative z-10 pb-6 sm:-mt-10 sm:pb-10" aria-label="Promotion">
        <div className="page-container">
          <div className="rounded-[24px] border border-white/60 bg-white/85 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.10)] backdrop-blur-xl sm:p-6">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.25em] text-brand-600">Fresh Batch Ready</p>
      ...
      {/* ── Categories ── */}
      <section className="bg-[#faf7f3] py-10 sm:py-14 lg:py-20" aria-labelledby="categories-heading">
        <div className="page-container">
          <div className="mb-6 flex flex-col gap-3 sm:mb-10 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-2xl">
              <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-[0.22em] text-brand-600">Shop by Category</p>
              <h2 id="categories-heading" className="mt-1 text-xl sm:text-3xl font-semibold text-earth-950">
          ...
          <div ref={scrollRef} className="flex gap-3 sm:gap-5 overflow-x-auto pb-4 no-scrollbar snap-x snap-mandatory" role="list" aria-label="Product categories">
              ...
              >
                <div className="relative aspect-[0.9] overflow-hidden rounded-[22px] sm:rounded-[28px] bg-earth-200 shadow-[0_12px_30px_rgba(15,23,42,0.08)]">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-3 sm:p-5">
                    ...
                    <h3 className="mt-2 text-base sm:text-2xl font-semibold text-white leading-tight">{cat.label}</h3>
      ...
      {/* ── Best Sellers ── */}
      <section className="bg-[radial-gradient(circle_at_top,#fff7ed,transparent_42%),linear-gradient(to_bottom,#ffffff,#fffaf5)] py-12 sm:py-16 lg:py-20" aria-labelledby="bestsellers-heading">
        <div className="page-container">
          <div className="mb-8 flex flex-col gap-4 sm:mb-10 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-600">Best Sellers</p>
              <h2 id="bestsellers-heading" className="mt-2 text-3xl font-semibold text-earth-950 sm:text-4xl">
          ...
          {loading ? (
            <div className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-3 lg:grid-cols-4" aria-label="Loading products">
      ...
      {/* ── Combos ── */}
      {combos.length > 0 && (
        <section className="bg-[#fdf8f4] pt-0 pb-12 sm:pb-16 lg:pb-20" aria-labelledby="combos-heading">
          <div className="page-container">
            <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-600">Bundle Deals</p>
                <h2 id="combos-heading" className="mt-2 text-3xl font-semibold text-earth-950 sm:text-4xl">Combo Offers</h2>
                <p className="mt-3 text-sm leading-7 text-earth-500 sm:text-base">
                  Save more when you buy together — handpicked combos curated for you.
                </p>
              </div>
              <Link
                to="/combos"
      ...
      {/* ── Why Choose Us ── */}
      <section className="py-12 sm:py-16 lg:py-20" aria-labelledby="why-heading">
        <div className="page-container">
          <div className="mb-10 max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-600">Why Choose Us</p>
            <h2 id="why-heading" className="mt-2 text-3xl font-semibold text-earth-950 sm:text-4xl">Why Our Customers Love Us</h2>
            <p className="mt-3 text-sm leading-7 text-earth-500 sm:text-base">
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {TRUST_POINTS.map((item) => {
              ...
              return (
                ...
                >
                  <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-50 text-brand-600 transition-transform duration-300 group-hover:scale-110" aria-hidden="true">
                    <Icon size={20} />
                  </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20" aria-labelledby="story-heading">
        <div className="page-container">
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-600">Our Story</p>
              <h2 id="story-heading" className="mt-2 max-w-xl text-3xl font-semibold text-earth-950 sm:text-4xl">Real Taste, Just Like Home</h2>
      ...
      {/* ── Testimonials ── */}
      <section className="relative overflow-hidden bg-[linear-gradient(180deg,#fff7ed_0%,#fffdf9_45%,#ffffff_100%)] py-12 sm:py-16 lg:py-20" aria-labelledby="testimonials-heading">
        <div className="absolute left-0 top-10 h-40 w-40 rounded-full bg-brand-100/60 blur-3xl" aria-hidden="true" />
        <div className="absolute bottom-0 right-0 h-48 w-48 rounded-full bg-orange-100/60 blur-3xl" aria-hidden="true" />
        <div className="page-container relative">
          <div className="mb-8 text-center sm:mb-10">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-600">Customer Love</p>
            <h2 id="testimonials-heading" className="mt-2 text-3xl font-semibold text-earth-950 sm:text-4xl">What our customers say</h2>
            <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-earth-500 sm:text-base">Real feedback from happy customers.</p>
          </div>
          <div className="grid grid-cols-1 gap-5 lg:grid-cols-3" role="list" aria-label="Customer testimonials">
            {TESTIMONIALS.map((t) => (
              <article
                key={t.name}
                ...
                role="listitem"
              >
                <div className="mb-5 flex gap-1 text-brand-500" aria-label={`${t.stars} out of 5 stars`}>
                  {Array.from({ length: t.stars }).map((_, i) => (
                    <FiStar key={i} className="fill-current" aria-hidden="true" />
                  ))}
                </div>
