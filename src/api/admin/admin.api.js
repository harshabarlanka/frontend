...
export const getAnalyticsAPI  = (period) => api.get('/admin/analytics', { params: { period } })
...
export const getAdminProductsAPI = (params)    => api.get('/products', { params: { ...params, limit: 50 } })
